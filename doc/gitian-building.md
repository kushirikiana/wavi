...
git clone https://github.com/kushirikiana/wavi
```
...
```bash
    ...
    From https://github.com/kushirikiana/wavi
...
cd /some/root/path/
git clone https://github.com/kushirikiana/wavi-detached-sigs.git
...
[wavi/gitian.sigs](https://github.com/kushirikiana/gitian.sigs/) repository, or if that's not possible to create a pull
request.
